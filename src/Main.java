...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4. Generate all files (HTML, CSS, JS, PHP)");
    ...
    private static void generateAllFiles() {
        System.out.println("🚀 بدء توليد جميع الملفات...");
        logger.info("🚀 بدء توليد جميع الملفات...");
